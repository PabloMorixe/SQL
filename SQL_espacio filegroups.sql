...
select * from #pocoespacio where PercentFree < @Alerta
...
--if (select count(*) FROM #PocoEspacio where PercentFree < @Alerta and dbname not in ('master','model','msdb','sqlmant') ) > 0
--exec msdb.dbo.sp_send_dbmail
--@profile_name = 'opesqladmin',
--@recipients = 'base.datos@supervielle.com.ar',
----@Copy_recipients = 'COEData&AdvancedAnalytics@supervielle.com.ar',
----@Copy_recipients = 'MobileBanking@supervielle.com.ar',
--@Copy_recipients = 'MonitoreoTI@supervielle.com.ar',
